...
//创建个img标签并且插入obj前面
var goods_img="";
$(':text[name=title]').bind('focus',function(){text_focus($('#info_title'),'文章标题');});
$(':text[name=title]').bind('blur',function(){text_blue($(this),$('#info_title'),'文章标题');});
...
function fabu(){
    ...
    if(bb.indexOf("undefined")!==-1){
        ...
        var a=text_blue($('input[name=title]'),$('#info_title'),'文章标题');
