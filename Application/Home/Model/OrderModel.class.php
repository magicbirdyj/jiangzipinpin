...
class  OrderModel extends Model {
    protected $fields=array(
        ...
        'appraise_img','cuihuo_time','kuaidi','fenxiang','fenxiang_dues','horseman_id','remind_horseman_time','shop_id','shop_note','shop_img','remind_user_time',
        'deliver_address','deliver_time','remind_pay_time','_autoinc'=>true
    );
}
