...
class FontEndController extends Controller {
    ...
    function __construct() {
        ...
        $login=array('Goods/pinglun','Goods/dandu_buy','Goods/kaituan_buy','Goods/cantuan_buy','Goods/dandu_buy_success','Goods/kaituan_success','Goods/cantuan_success','Goods/zhifu','Goods/alipay','Goods/weixin_zhijiezhifu','Goods/gmcg_wx','Goods/jiance_pay','Goods/sellection_join','Goods/pinglun','Goods/pinglun');//需要登录的方法
