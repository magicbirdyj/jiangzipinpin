...
<body>
    ...
    <ul>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li style='height:30px;line-height: 30px;border: 1px solid #00FFDB;margin-top: 10px;width: 80%;margin-left: 10%;'>
            <a href="<?php echo U('member/login',array('user_id'=>$vo['user_id']));?>" style='display: block'><?php echo ($vo['user_name']); ?></a>
