...
<tr class="buy_table_head">
    <td colspan="2">
        ...
        <div class="goods_name">
            ...
            <div class="name_price">&yen <span class="price_red"><?php echo (floatval($goods['price'])); ?> </span> /<?php echo ($goods['units']); ?> </div>
        </div>
    </td>
</tr>
...
<tr class="buy_table_content">
    ...
    <td class="td_r yingfu">&yen <span id="dues"><?php echo (floatval($goods['price']-$goods['ky_daijinquan'])); ?></span></td>
</tr>


</table>
   
    <form name="dingdan" method="post" action="<?php echo U('Goods/dandu_buy_success');?>">
...
<script>
        var ky_daijinquan=0;
        var price=parseInt(<?php echo (floatval($goods['price'])); ?>);
