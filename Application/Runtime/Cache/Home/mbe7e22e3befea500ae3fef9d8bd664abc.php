...
<link rel="stylesheet" type="text/css" href="/Public/Home/Mobile/Css/iconfont/iconfont_sousou/iconfont.css">
</head>
...
<body>
    ...
    <script  type="text/javascript">
        ...
        $('#sr').bind('click',function(){
            var a=$('input[name=sp]').val();
            var b,c;
            if(Trim($('input[name=sp]').val())==''){
                a=$('input[name=sp]').attr('placeholder');
                $('input[name=sp]').val(a);
            }
            b="/Home/Index/search";
            c=b+'/sp/'+a+'.html';
            $('#searchform').attr('action',c);
        });
