...
<div class="fanhui padding"><a href="javascript:history.back()"><span class="iconfont tb_fanhui"id="shangjia_info_fanhui">&#xe603;</span></a>提交开团订单</div>
...
<tr class="buy_table_content">
    ...
    <form name="dingdan" method="post" action="<?php echo U('Goods/kaituan_success');?>">
